...
public interface ListEbsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:didi.cloud.compute.v1.ListEbsRequest)
   ...
   * <code>.didi.cloud.compute.v1.ListEbsCondition condition = 5;</code>
   */
  com.didiyun.compute.v1.ListEbsCondition getCondition();
  /**
   * <pre>
   *过滤条件
   * </pre>
   ...
   * <code>.didi.cloud.compute.v1.ListEbsCondition condition = 5;</code>
   */
  com.didiyun.compute.v1.ListEbsConditionOrBuilder getConditionOrBuilder();
}
